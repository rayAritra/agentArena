  ...
  return <div className="container py-12">
    ...
    <div className="card mt-10 overflow-hidden">
      <MetricStrip
        ...
        items={[
          { label: "DEX markets", value: withMarkets.length.toLocaleString() },
          { label: "Reference assets", value: tokens.length.toLocaleString() },
          { label: "Warnings", value: alerts.length.toLocaleString(), tone: alerts.length ? "warning" : "positive" },
        ]}
      />
    </div>
    <ScrollReveal className="mt-12 grid gap-5 sm:grid-cols-2 xl:grid-cols-4">{rows.map((token) => {
